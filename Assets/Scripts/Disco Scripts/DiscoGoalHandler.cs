...
public class DiscoGoalHandler : MonoBehaviour
{

    [SerializeField]
    Text scoreText, scoreRedText, scoreGreenText, scoreBlueText, scoreYellowText, whereToScoreText;
    [SerializeField]
    GameObject arrow, ball, car, explosion, eventHandlerObject;
    ...
    [SerializeField]
    AudioClip goalScored_Sound, background_intro_sound, background_body_sound, countdown_sound;
    [SerializeField]
    AudioSource source;
    ...
    void updateWhereToScore()
    {
        ...
        Color _sideColor = Color.red;
        switch (whereToScore)
        {   //Look at this and tell me how you would do it, i could create it into one statement but i dont know whats better
